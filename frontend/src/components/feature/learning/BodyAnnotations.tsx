...
import { AskAiPanel } from '@/components/feature/explain/AskAiPanel';
import { MarkdownView } from '@/components/primitive/MarkdownView';
import { selectionEndpointRect, type SelectionRect } from '@/lib/selectionGeometry';
import { applyHighlights, selectionToTextAnchor } from '@/lib/summaryHighlights';

...
vi.mock('@/features/projects/api/projects', () => ({ useProject: (...args: unknown[]) => useProject(...args) }));
vi.mock('@/app/api/health', () => ({ useHealth: () => useHealth() }));
vi.mock('@/features/learning', () => ({
  LearningWorkspace: () => <div>teacher-workspace</div>,
}));
vi.mock('@/features/projects/components/LegacyProjectView', () => ({

...
import { useConfusions, useCreateConfusion } from '@/features/legacy-zones';
import { useExplainManifest, useExplainPage } from '@/features/legacy-zones';
import { useRecordReading } from '@/features/projects';
import { EmptyState } from '@/shared/primitive/EmptyState';
import { OutputViewer } from '@/features/projects';
...
import {
  ...
  type TextAnchor,
} from '@/shared/lib/summaryHighlights';
import {
...
import {
  ...
  type SelectionRect,
} from '@/shared/lib/selectionGeometry';
...
function ExplainPage({
  ...
  useEffect(() => {
    ...
    const finishAtPoint = (event: MouseEvent | PointerEvent) => {
      ...
      // the range on the next frame so the toolbar is anchored to the actual
      // release line instead of a stale/middle range box.
